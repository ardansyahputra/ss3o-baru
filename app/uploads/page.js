...
import { getUserJobdesks, uploadRowsFor } from "@/lib/data";
...
export default async function UploadsPage() {
  ...
  if (user.role === "ADMIN") {
    ...
    return <AppShell title="Upload Dokumen" user={user}><div className="page-header"><div><p className="eyebrow">Proof inspection</p><h1 className="page-title">Kelola Bukti Upload</h1><p className="page-subtitle">Saring dan periksa seluruh bukti kerja yang dikirim staff.</p></div></div><UploadAdminView uploads={uploads} /></AppShell>;
  }
